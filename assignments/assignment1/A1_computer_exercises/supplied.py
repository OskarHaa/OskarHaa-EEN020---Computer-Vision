...
def rital(lines, st='r-'):
    """ rital takes as input a 3xn matrix "lines" where each column represents the homogeneous 
    coordinates of a 2D line. It then plots those lines. The optional second argument "st" controls 
